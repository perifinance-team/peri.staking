        ...
        <Card isActive={isActive}>
            ...
            <InputContainer>
                <RowContainer margin={'0px'}>
                    ...
                    {isActive && <ClaimAble align={'right'} weigth={'sb'}>STATUS: {data.claimable ? 'OPEN' : 'CLOSE'}</ClaimAble>}
                </RowContainer>
                <RowContainer>
                    <Lable>{'PERI'}</Lable>
                    <Input currencyName={'PERI'} value={formatCurrency(data.rewards.staking, 2)} color={'primary'} disabled={true}/>
                </RowContainer>
                <RowContainer>
                    <Lable>{'pUSD'}</Lable>
                    <Input currencyName={'pUSD'} value={formatCurrency(data.rewards.exchage, 2)} color={'primary'} disabled={true}/>
                </RowContainer>
                ...
                <ColContainer>
                    ...
                    <RoundButton height={30} onClick={() => rewardAction()} padding={0} color={'tertiary'} border={'tertiary'} width={320} margin={'0px 20px 0px 0px'}>
