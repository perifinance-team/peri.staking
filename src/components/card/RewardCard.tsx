        ...
        <Card isActive={isActive}>
            ...
            <InputContainer>
                <RowContainer margin={'0px'}>
                    ...
                    {isActive && <ClaimAble align={'right'} weight={'sb'}>STATUS: {data.claimable ? 'OPEN' : 'CLOSE'}</ClaimAble>}
                </RowContainer>
                <RowContainer>
                    <Label>{'PERI'}</Label>
                ...
                <RowContainer>
                    <Label>{'pUSD'}</Label>
                    <Input currencyName={'pUSD'} value={formatCurrency(data.rewards.Exchange, 8)} color={'primary'} disabled={true}/>
                </RowContainer>
